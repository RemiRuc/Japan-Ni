<template>
   <svg id="Calque_1" data-name="Calque 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 659 736.01">
    <g>
        ...
        <router-link exact :to="{name: 'City', params:{city:'kobe'}}" id="kobeGroup">
        <circle id="kobe" class="cls-1 link" cx="247" cy="532.99" r="5"/>
        </router-link>
        <circle class="cls-1" cx="258" cy="532.99" r="5"/>
        <router-link exact :to="{name: 'City', params:{city:'osaka'}}" id="osakaGroup">
        <circle id="osaka" class="cls-1 link" cx="268.99" cy="532.99" r="5"/>
        </router-link>
        <router-link exact :to="{name: 'City', params:{city:'nara'}}" id="naraGroup">
        <circle id="nara" class="cls-1 link" cx="279.99" cy="532.99" r="5"/>
        </router-link>
        ...
        <router-link exact :to="{name: 'City', params:{city:'miyajima'}}" id="miyajimaGroup">
        <circle id="miyajima" class="cls-1 link" cx="136.99" cy="554.99" r="5"/>
        </router-link>
        <router-link exact :to="{name: 'City', params:{city:'hiroshima'}}" id="hiroshimaGroup">
        <circle id="hiroshima" class="cls-1 link" cx="148" cy="554.99" r="5"/>
        </router-link>
        ...
        <router-link exact :to="{name: 'City', params:{city:'tokyo'}}" id="tokyoGroup">
        <circle id="tokyo" class="cls-1 link" cx="423" cy="500" r="5"/>
        </router-link>
        ...
        <router-link exact :to="{name: 'City', params:{city:'takayama'}}" id="takayamaGroup">
        <circle id="takayama" class="cls-1 link" cx="335" cy="455.99" r="5"/>
        </router-link>
        ...
        <router-link exact :to="{name: 'City', params:{city:'yugawara'}}" id="yugawaraGroup">
        <circle id="yugawara" class="cls-1 link" cx="401" cy="511" r="5"/>
        </router-link>
        ...
        <router-link exact :to="{name: 'City', params:{city:'matsumoto'}}" id="matsumotoGroup">
            <circle id="matsumoto" class="cls-1 link" cx="346" cy="455.99" r="5"/>
        </router-link>
        ...
        <router-link exact :to="{name: 'City', params:{city:'hakuba'}}" id="hakubaGroup">
        <circle id="hakuba" class="cls-1 link" cx="356.99" cy="445" r="5"/>
        </router-link>
        <circle class="cls-1" cx="378.99" cy="434" r="5"/>
        <router-link exact :to="{name: 'City', params:{city:'yokohama'}}" id="yokohamaGroup">
        <circle id="yokohama" class="cls-1 link" cx="423" cy="511" r="5"/>
        </router-link>
    </g>
    </svg>
...
export default {
    ...
    methods: {
        changeActual: function() {
            Travel.methods.refresh(event.target);
        }
    },
    mounted(){
